            ...
            <div class="flex flex-1  flex-col md:flex-row lg:flex-row mx-2">
                <div class="mb-2 border-solid border-gray-300 rounded border shadow-sm w-full">
                    <div class="bg-gray-200 px-2 py-3 border-solid border-gray-200 border-b">
                        COMPTE DES PROMOTEURS
                    </div>
                    <div class="p-3">
                        <table class="table-responsive w-full rounded">
                            <thead>
                              <tr>
                                <th class="border w-1/7 px-4 py-2">NOM</th>
                                <th class="border w-1/8 px-4 py-2">PRENOM</th>
                                <th class="border w-1/8 px-4 py-2">AGE</th>
                                <th class="border w-1/9 px-4 py-2">EMAIL</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="border px-4 py-2">{{$user->roles}}

                                    <td class="border px-2 py-2">
                                        <a href="#" class="bg-teal-300 cursor-pointer rounded p-1 mx-1 text-end">BLOQUER</a>
                                        <a href="#" class="bg-teal-300 cursor-pointer rounded p-1 mx-1 text-black">DEBLOQUER</a>
