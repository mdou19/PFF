        ...
        <div class="flex flex-1">
            ...
            <div class="flex flex-1  flex-col md:flex-row lg:flex-row mx-2">
                <div class="mb-2 border-solid border-gray-300 rounded border shadow-sm w-full">
                    ...
                    <div class="p-3">
                        <table class="table-responsive w-full rounded" style="color: black">
                            <thead>
                              <tr>
                                <th class="border w-1/7 px-4 py-2">NOM EVENEMENT</th>
                                <th class="border w-1/5 px-4 py-2">TYPE EVENEMENT</th>
                                <th class="border w-1/5 px-4 py-2">DATE D'EVENEMENT</th>
                                <th class="border w-1/5 px-4 py-2">DESCRIPTION</th>
                                <th class="border w-1/5 px-4 py-2">AFFICHE</th>
                                <th class="border w-1/5 px-4 py-2">LIEUX EVENEMENT</th>
                                <th class="border w-1/5 px-4 py-2">PROMOTEUR</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="border px-4 py-2">{{$evenement->type_evenement}}</td>
                                    <td class="border px-4 py-2">{{$evenement->date_evenement}}</td>
                                    <td class="border px-4 py-2">{{$evenement->descriptions}}</td>
                                    <td><img src="{{$evenement->image_path}}" alt="{{$evenement->image_path}}" style="width: 150px;"></td>
                                    <td class="border px-4 py-2">{{$evenement->lieu->nom_lieux}}</td>
                                    <td class="border px-4 py-2">{{$evenement->user->prenom}}</td>
