    ...
    <hr/ style="color:maroon" width="750px">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                @endif
                <form method="POST" action="{{ route('evenements.reserver')}}">
                @csrf

                <div class="md-3">
                    <label class="form-label">Nom Evenement</label>
                    <input type="text" class="form-control" name="nom_evenement" placeholder="Entrer votre Nom_Evenement" value="{{old('nom_evenement')}}">
                    @error('nom_evenement')
                ...
                <div class="md-3">
                    ...
                    <input type="text" class="form-control" name="type_evenement" placeholder="Entrer votre Type_Evenement" value="{{old('type_evenement')}}">
                ...
                <div class="md-3">
                    ...
                    <input type="date" class="form-control" name="date_evenement" placeholder="Entrer votre Nom_Evenement" value="{{old('date_evenement')}}">
                ...
                <div class="md-3">
                    ...
                    <textarea type="text" class="form-control" name="descriptions" placeholder="Descriptions de votre Evenement" value="{{old('descriptions')}}"></textarea>
                    @error('descriptions')
                        <div class="alert alert-danger" role="alert">
                            {{$message}}
                        </div>
                ...
                <div class="md-3">
                    ...
                    <input type="file" class="form-control" name="images" placeholder="Entrer votre image" value="{{old('images')}}">
                    @error('images')
                        <div class="alert alert-danger" role="alert">
                            {{$message}}
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <select name="lieux" class="form-control" style="width:185px" value="{{old('lieux')}}">
                            @foreach ($lieuxes as $lieux)
                                <option value="{{$lieux->id}}" {{ old('lieux') == $lieux->id ? 'selected' : '' }} > {{$lieux->nom_lieux}}</option>
                            @endforeach
                        </select>
                    </div>
